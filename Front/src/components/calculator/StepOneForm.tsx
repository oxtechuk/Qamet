...
const inputCls =
    "h-[52px] w-full rounded-[10px] border border-[#E5E7EB] bg-[#F9FAFB] px-4 text-[14px] text-[#111827] outline-none placeholder:text-[#9CA3AF] focus:border-[var(--brand-primary-color)] focus:ring-2 focus:ring-[rgba(41,155,224,0.12)] transition";
...
export default function StepOneForm({ onNext }: IStepOneFormProps) {
    ...
    return (
        <div
            dir={direction}
            className="rounded-[20px] border border-[#E5E7EB] bg-white px-6 py-8 shadow-sm"
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                    <label className="mb-1.5 block text-[13px] font-bold! text-[#374151]">
                        {t("financeCalculator.step1.fullName")}{" "}
                ...
                <div>
                    <label className="mb-1.5 block text-[13px] font-bold! text-[#374151]">
                        {t("financeCalculator.step1.phone")}{" "}
                        <span className="text-red-500">*</span>
                    </label>
                    <input
                        type="tel"
                ...
                <label className="flex cursor-pointer items-start gap-3 text-[13px] text-[#6B7280]">
                    ...
                    <span>
                        ...
                        <a
                            href="/privacy"
                            className="text-black! !underline decoration-1 underline-offset-2 font-bold"
                        >
                            {t("financeCalculator.step1.consentLink")}
                        </a>{" "}
