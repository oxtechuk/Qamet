...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-55MZCJ7Z');</script>
    <!-- End Google Tag Manager -->
        ...
        snaptr('init', '84c3351e-4d60-430d-9c66-dc0cf889ed32', {
        'user_email': ''
        });
    ...
    <body>
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-55MZCJ7Z"
        height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        <!-- End Google Tag Manager (noscript) -->

        <!-- Meta Pixel (noscript) -->
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=1057716843499038&ev=PageView&noscript=1"
        /></noscript>
