...
class StatsOverviewWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $monthlyRevenue = (clone $soldRevenue)->whereMonth('created_at', now()->month)->sum('total_price');
        $totalRevenue = (clone $soldRevenue)->sum('total_price');
        $monthlyCount = (clone $soldRevenue)->whereMonth('created_at', now()->month)->count();
        ...
        return [
            ...
            Stat::make(__('Sales Team'), Employee::count())
                ->description(__('Active staff members'))
