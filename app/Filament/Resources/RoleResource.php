...
class RoleResource extends Resource
{
    ...
    {
        return [
            'الطلبات والحجوزات ومبيعات الكاش والتقسيط' => [
                'icon' => 'heroicon-o-shopping-cart',
                'description' => 'تحديد نوع الطلبات التي يراها الموظف (كاش / تقسيط / شركات / شامل)',
                'permissions' => [
                    'manage-bookings' => [
                        'label' => 'إدارة وعرض كافة الطلبات (شامل كاش وتقسيط)',
                        'description' => 'الوصول لجميع أنواع طلبات الشراء الكاش والتقسيط والشركات',
                    ],
                    'manage-cash-bookings' => [
                        'label' => 'إدارة وعرض طلبات الكاش فقط 💵',
                        'description' => 'قصر صلاحيات المندوب على طلبات الدفع النقدي (الكاش) فقط',
                    ],
                    'manage-finance-bookings' => [
                        'label' => 'إدارة وعرض طلبات التقسيط والتمويل فقط 💳',
                        'description' => 'قصر صلاحيات المندوب على طلبات التقسيط والتمويل البنكي للأفراد',
                    ],
                    'manage-corporate-bookings' => [
                        'label' => 'إدارة وعرض طلبات تمويل الشركات 🏢',
                        'description' => 'الاطلاع على طلبات أساطيل وتمويل الشركات والمؤسسات',
                    ],
                    'manage-tracking' => [
            ...
            'السيارات والكتالوج' => [
                ...
                'permissions' => [
                    ...
                    'view-cars-showcase' => [
                        'label' => 'عرض كتالوج السيارات 🖼️',
                        'description' => 'الوصول لصفحة عرض السيارات مع البحث والتصفية وتحميل الصور',
                    ],
                ],
            ],
