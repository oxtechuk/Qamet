...
use App\Filament\Resources\CalculatorBankResource\Pages;
...
class CalculatorBankResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('annual_rate')->label(__('Annual Rate'))->suffix('%')->sortable(),
    ...
    {
        return [
            'index' => Pages\ListCalculatorBanks::route('/'),
            'create' => Pages\CreateCalculatorBank::route('/create'),
            'edit' => Pages\EditCalculatorBank::route('/{record}/edit'),
        ];
    }
}
